...
- **Node.js** ≥ 20
- **npm** (ships with Node)
- An Oz control plane (agent API) + API key (for running agents)
...
Then edit `.env.local` to add your Oz API key, environment ID, and callback URL.
